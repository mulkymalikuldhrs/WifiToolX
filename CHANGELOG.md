...
### Added
- Web interface dashboard with glassmorphism design
- Automated attack daemon
- Python WebSocket server for terminal integration
- AI password generation with Google AI
